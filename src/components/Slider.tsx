...
function Slider({ images }: SliderProps) {
  ...
  return (
    <div className="sm:max-w-[1400px] sm:h-[780px] h-[420px] w-full m-auto pt-6 pb-16 sm:py-16 sm:px-4 relative group">
      <div
        style={{ backgroundImage: `url(${images[currentSlide].url})` }}
        className="w-full h-full rounded-2xl bg-center bg-cover duration-500 border"
      ></div>
      {/* Left Arrow */}
